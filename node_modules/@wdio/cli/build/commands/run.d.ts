...
export declare const builder: (yargs: yargs.Argv<{}>) => yargs.Argv<yargs.Omit<{}, "framework" | "reporters" | "hostname" | "port" | "path" | "baseUrl" | "spec" | "user" | "key" | "logLevel" | "watch" | "exclude" | "bail" | "waitforTimeout" | "cucumberOpts" | "suite" | "mochaOpts" | "jasmineNodeOpts"> & yargs.InferredOptionTypes<{
    readonly watch: {
        readonly desc: "Run WebdriverIO in watch mode";
        readonly type: "boolean";
    };
